...
class FutureForecastRouter: MVVMRouter {
    ...
    func present(on baseVC: UIViewController, animated: Bool, context: Any?, completion: ((Bool) -> Void)?) {
        ...
        let vc = FutureForecastVC.instantiateFromStoryboard(storyboardName: "FutureForecast", storyboardId: "FutureForecastVC")
        let viewModel = FutureForecastVM.init(with: self, weatherManager: dependencies.weatherManager, locationManager: dependencies.locationManager)
